                  ...
                  <div class="table-responsive table-invoice">
                    <table class="table table-striped">
                      ...
                      <tr>
                          ...
                          <td><?php echo $data['penyebab_kerusakan']; ?></td>
                          <td><?php echo $data['solusi_kerusakan']; ?></td>

                          <td>
                            <a href="form_edit.php?id_kerusakan=<?= $data['id_kerusakan']; ?>" class="btn btn-primary">Edit</a>
                            <a href="hapus.php?id_kerusakan=<?= $data['id_kerusakan']; ?>" class="btn btn-primary">Hapus</a>
                        </td>
                      </tr>
                  		<?php } ?>
                    </table>
